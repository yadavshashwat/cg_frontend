...
$(document).ready(function(){
    ...
    if (vehtype == "Car" && service == "CarCare"){
        ...
        var DESC = "CarCrew ASSIT is a premium road-side assistance programe, providing assistance anytime, anywhere, 24 hours a day, 7 days a week and 365 days a year. We have best of its kind pan-India network along with 24x7 assistance centre, duly approved by DOT."
        // var FEATURES = "OES/OEM Parts used&nbsp;<i class='fa fa-check x10 icon'></i>&nbsp;Trained mechanics&nbsp;<i class='fa fa-check x10 icon'></i>&nbsp;Free pick up and drop"
        // $('.car-service').show()
        $('.car-image').show()
